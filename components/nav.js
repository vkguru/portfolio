    ...
    <nav className={navStyles.nav}>
      ...
      <div className={navStyles.menu}>
        {menuOpen === false?
          ...
          :
          <div className={navStyles.hambugerOpen} onClick={openMenu}>
            <motion.span initial="hidden" animate="rotate" variants={rotate} className={navStyles.crossbar}></motion.span>
            <motion.span initial="hidden" animate="rotate" variants={rotate_} className={navStyles.crossbar} className={navStyles.crossbar_alt}></motion.span>
          </div>
        }
      </div>
    </nav>
      ...
      {menuOpen === true?         
        <div className={navStyles.menuOpen}>
          ...
          <div className={navStyles.menuList}>
            <ul>
              <motion.li initial="hidden" animate="moveup" variants={navFadeUp}>
                <Link href="/"><a>About</a></Link>
              </motion.li>
              <motion.li initial="hidden" animate="moveup" variants={navFadeUpOne}>
                <Link href="https://vkguru.hashnode.dev"><a target="_blank">Articles</a></Link>
              </motion.li>
          ...
          <motion.div initial="hidden" animate="moveup" variants={fadeupHomeThree} className={navStyles.social}>
          ...
          {/* <div className={navStyles.sp}></div> */}
        </div>
        :
        ''
      }
